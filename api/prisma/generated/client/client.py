...
SCHEMA_PATH = Path('C:/Users/tinma/Desktop/Praksa/api/prisma/schema.prisma')
PACKAGED_SCHEMA_PATH = Path(__file__).parent.joinpath('schema.prisma')
ENGINE_TYPE: EngineType = EngineType.binary
BINARY_PATHS = model_parse(BinaryPaths, {'queryEngine': {'windows': 'C:\\Users\\tinma\\Desktop\\Praksa\\node_modules\\prisma\\query-engine-windows.exe'}, 'introspectionEngine': {}, 'migrationEngine': {}, 'libqueryEngine': {}, 'prismaFmt': {}})
...
class Prisma(AsyncBasePrisma):
    ...
    userreminders: 'actions.UserRemindersActions[models.UserReminders]'
    ...
    def __init__(
        ...
        *,
        ...
        self.userreminders = actions.UserRemindersActions[models.UserReminders](self, models.UserReminders)
    ...
    def _default_datasource(self) -> Datasource:
        return {
            ...
            'source_file_path': 'C:/Users/tinma/Desktop/Praksa/api/prisma/schema.prisma',
        }
...
class Batch:
    userreminders: 'UserRemindersBatchActions'

    def __init__(self, client: Prisma) -> None:
        self.__client = client
        self.__queries: List[str] = []
        self._active_provider = client._active_provider
        self.userreminders = UserRemindersBatchActions(self)
...
class UserRemindersBatchActions:
